{
  ...
  cfg = osConfig.faery.programs.opentablet;
in {
  config = mkIf cfg.enable {
    # Ngl maybe this is very dumb. Will find out once I start drawing again lol.
    xdg.configFile."OpenTabletDriver/settings.json".text = builtins.toJSON {
      Profiles = [
        {
